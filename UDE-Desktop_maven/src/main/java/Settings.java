...
public class Settings {
  ...
  private String imgPath, line, defaultBG = "generic-theme/background.png";
  ...
  private Settings() {
    // Setup window
    try {
      scene = new Scene(FXMLLoader.load(Settings.class.getResource("SettingsManagerWindow.fxml")), 800, 600);
    } catch (Exception e) {
